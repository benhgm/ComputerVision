...
class VisualOdometry():
    def __init__(self, data_dir):
        self.K, self.P = self.__load_calib(os.path.join(data_dir, 'calib.txt'))
        self.gt_poses = self._load_poses(os.path.join(data_dir, 'poses.txt'))
        self.imags = self._load_images(os.path.join(data_dir, 'image_l'))
    ...
    def _load_calib(filepath):
        """
        Function to load the calibration parameters of the camera
        ...
        Returns:
            ...
            P (ndarray): Camera projection matrix
        """
    ...
    def _load_poses(filepath):
        ...
        Args:
            filepath (str): Path to the groud truth poses
        
        Returns:
            poses (ndarray): Ground truth poses
        """
        poses = []
        with open(filepath, 'r') as f:
    ...
    def decomp_essential_mat(self, E, q1, q2):
        ...
        T3 = self._form.transf(R1, np.ndarray.flatten(-t))
